...
| TM-005 | Compromised federation hub forges authority, suppresses events or gains cell secrets. | Hub or operator account compromised; cells over-trust hub data. | Misdirection, delayed handoff, privacy loss and cross-cell compromise. | Hub has no cell keys, verifies but cannot originate cell signatures, two hubs, outbound-only gateways, local autonomy, signed events and reconciliation. | P0-05 malicious-hub simulation and 24h dual-hub-loss replay pass; physical key inventory and failover drill remain planned. Owners: federation + security. | Hub can delay/drop visible traffic and analyze permitted metadata; runtime and physical custody remain unverified. | High |
