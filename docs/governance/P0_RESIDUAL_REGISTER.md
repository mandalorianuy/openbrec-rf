...
| P0-R010 | P0-01 define payloads y boundaries; energía, crypto/SOS y modelos de transportes fueron resueltos por P0-02–P0-04, pero federación, terminal y beacon runtime siguen pendientes. | P0-02–P0-04 slices resolved; planned para P0-05–P0-07 | owners de cada task consumidora | Cada task restante debe implementar sus invariantes con replay/fallos y no puede usar schemas ni gates anteriores como prueba de su runtime. | gates y receipts P0-05–P0-07 | Claim funcional, operativo o físico basado sólo en contratos/modelos previos bloquea aceptación de la task consumidora y P0-09. |
