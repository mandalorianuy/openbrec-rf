...
| P0-R010 | P0-01 define payloads y boundaries; energía fue resuelta por P0-02 y crypto/SOS/política genérica por P0-03, pero adapters, federación, terminal y beacon runtime siguen pendientes. | planned para P0-04–P0-07; P0-02/P0-03 slices resolved | owners de cada task consumidora | Cada task restante debe implementar sus invariantes con replay/fallos y no puede usar schema ni gates anteriores como prueba de su runtime. | gates y receipts P0-04–P0-07 | Claim funcional, operativo o físico basado sólo en contrato/P0-03 bloquea aceptación de la task consumidora y P0-09. |
