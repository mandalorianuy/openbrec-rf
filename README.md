...
| Integración con ecosistema SAR | [Ecosystem integration](docs/guides/ecosystem-integration.md) |
| AP de emergencia (excepción gobernada) | [Emergency autojoin](docs/guides/emergency-autojoin.md) |
