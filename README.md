...
Cada evidencia de inspección debe ser única y declarar un `inspector` no
placeholder; `duplicate_inspection_evidence_groups` lo verifica sin autenticar
la evidencia física ni la identidad declarada.
...
- [`docs/open-spec/README.md`](docs/open-spec/README.md) — bundle Open Spec, conformance, publicación offline y contribuciones comunitarias.
- [`docs/decision-matrices/open-spec-functionality-matrix.json`](docs/decision-matrices/open-spec-functionality-matrix.json) — matriz normativa por funcionalidad sin score agregado ni ganador universal.
